...
class DockerComponentLauncherTest(tf.test.TestCase):
  ...
  def testLaunch_succeed_withoutConfig(self, mock_docker_client,
                                       mock_publisher):
  ...
  def testLaunch_succeed_withConfig(self, mock_docker_client, mock_publisher):
    mock_publisher.return_value.publish_execution.return_value = {}
    mock_run = mock_docker_client.return_value.containers.run
    mock_run.return_value.logs.return_value = []
    mock_run.return_value.wait.return_value = {'StatusCode': 0}
  ...
  def _create_launcher_context(self, platform_config=None):
